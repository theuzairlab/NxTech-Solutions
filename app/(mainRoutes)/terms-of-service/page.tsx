...
export const metadata: Metadata = {
  title: "Terms of Service - NxTech Solutions",
  description: "Terms of Service for NxTech Solutions",
};
            ...
            <div className="text-foreground space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  By accessing and using NxTech Solutions' website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Permission is granted to temporarily access the materials on NxTech Solutions' website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  NxTech Solutions provides IT services, digital marketing, AI solutions, web development, and related services. We reserve the right to modify, suspend, or discontinue any service at any time without prior notice.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The Service and its original content, features, and functionality are and will remain the exclusive property of NxTech Solutions and its licensors. The Service is protected by copyright, trademark, and other laws.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  In no event shall NxTech Solutions, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  These Terms shall be interpreted and governed by the laws of the jurisdiction in which NxTech Solutions operates, without regard to its conflict of law provisions.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mt-2">
                  Email: info@nxtech-solutions.com<br />
                  Website: www.nxtech-solutions.com
                </p>
              </div>
            </div>
          </div>
